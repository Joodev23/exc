...
{ "Sewc-ch-uwa-Archp": "Private" },
 ...
 if (cluster.isMaster) {
    console.clear();
    console.log(`--------------------------------------------`.blue);
    console.log(`Target: `.blue + process.argv[2].rainbow);
    console.log(`Time: `.blue + process.argv[3].rainbow);
    console.log(`Rate: `.blue + process.argv[4].rainbow);
    console.log(`Thread: `.blue + process.argv[5].rainbow);
    console.log(`ProxyFile: `.blue + process.argv[6].rainbow);
    console.log(`--------------------------------------------`.blue);
